...
public:
    ...
    void TestSolvingCircum() throw(Exception)
    {
        ...
        OutputFileHandler output_file_handler("TestLaplaceHSB016", false);

        out_stream p_file = output_file_handler.OpenOutputFile("linear_solution_circum.txt");
        ...
        out_stream p_file_grad = output_file_handler.OpenOutputFile("grad_circum.txt");
        out_stream p_file_grad_mag = output_file_handler.OpenOutputFile("mag_grad_circum.txt");
        ...
        VtkMeshWriter<3u, 3u> mesh_writer("TestLaplaceHSB016", "mesh", false);
