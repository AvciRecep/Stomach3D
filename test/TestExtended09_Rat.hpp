...
private:
    void Extended() //throw (Exception)
    {
        ...
        HeartConfig::Instance()->SetOutputDirectory("Stomach3D_rat_16_16_1_dt1s_20s_000001_0001_5");
        ...
        HeartConfig::Instance()->SetIntracellularConductivities(Create_c_vector(0.000001,0.0001,0.5));//(0.03, 3.4, 1.0));
        HeartConfig::Instance()->SetExtracellularConductivities(Create_c_vector(0.000001,0.0001,0.5));//(0.03, 3.4, 1.0));
        ...
        extended_problem.SetIntracellularConductivitiesForSecondCell(Create_c_vector(0.000001,0.0001,0.5));//(0.02, 3.4, 1.0));
