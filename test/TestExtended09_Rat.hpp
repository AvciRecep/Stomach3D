...
private:
    void Extended() //throw (Exception)
    {
        ...
        HeartConfig::Instance()->SetIntracellularConductivities(Create_c_vector(0.0005,0.005,0.05));//(0.03, 3.4, 1.0));
        HeartConfig::Instance()->SetExtracellularConductivities(Create_c_vector(0.0005,0.005,0.05));//(0.03, 3.4, 1.0));
        ...
        extended_problem.SetIntracellularConductivitiesForSecondCell(Create_c_vector(0.0005,0.005,0.05));//(0.02, 3.4, 1.0));
