...
private:
    void Extended() //throw (Exception)
    {
        ...
        HeartConfig::Instance()->SetIntracellularConductivities(Create_c_vector(0.000001,0.0001,0.2));//(0.03, 3.4, 1.0));
        HeartConfig::Instance()->SetExtracellularConductivities(Create_c_vector(0.000001,0.0001,0.2));//(0.03, 3.4, 1.0));
        ...
        extended_problem.SetIntracellularConductivitiesForSecondCell(Create_c_vector(0.000001,0.0001,0.2));//(0.02, 3.4, 1.0));
