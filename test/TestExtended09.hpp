...
public:
    ...
    {
        std::ifstream inLaplaceInfo("linear_solution_longi.txt");
        if(!inLaplaceInfo)
        {
...
private:
    void ExtendedRemaing() throw (Exception)
    {
        ...
        HeartConfig::Instance()->SetSimulationDuration(80000);
        p_problem->Solve();
        delete p_problem;
    }
...
private:
    void Extended() throw (Exception)
    {
        ...
        HeartConfig::Instance()->SetOdePdeAndPrintingTimeSteps(0.1,1,200);
        ...
        HeartConfig::Instance()->SetSimulationDuration(40000);  //ms.
        ...
        HeartConfig::Instance()->SetOutputDirectory("Extended");
        HeartConfig::Instance()->SetOutputFilenamePrefix("results");

        HeartConfig::Instance()->SetMeshFileName("H09ext_4_4_1.1", cp::media_type::Orthotropic);
